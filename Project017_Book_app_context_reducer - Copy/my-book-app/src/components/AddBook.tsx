    ...
    savingDetails = ( e:React.MouseEvent) =>{
        ...
        axios({
            ...
            data : {
                ...
                // rating : this.state.rating,
                // cover : this.state.cover
                author : this.context.books.book.author, 
                title : this.context.books.book.title,
                price: this.context.books.book.price,
                rating : this.context.books.book.rating,
                cover : this.context.books.book.cover
            }
        })
        .then(res => {
